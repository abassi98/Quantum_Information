...
set key left 
set term png
set output 'data/evolution.png'
set xlabel "x"
set ylabel "|{/Symbol y}|"

p [-5:5]"data/time_ev.txt" u 1:2 ls 1 ti "t=0", "data/time_ev.txt" u 1:500 ls 2 ti "t=4", "data/time_ev.txt" u 1:1000 ls 3 ti "t=8","data/time_ev.txt" u 1:1500 ls 4 ti "t=12","data/time_ev.txt" u 1:2000 ls 4 ti "t=16"
const1=1
const2=0.6
vel=0.05
f(x)=const1
...
fit f(x) 'data/statistics.txt' u 1:2 via const1
fit g(x) 'data/statistics.txt' u 1:4 via const2
fit h(x) 'data/statistics.txt' u 1:3 via vel

set output "data/statistics.png"
set xlabel "t"
set ylabel " "
p [0:20][-0.6:1.5] "data/statistics.txt" u 1:3 ls 2 ti "Average position around vt",h(x) ls 6 notitle, "data/statistics.txt" u 1:4 ls 3 ti "Maximum value",g(x) ls 6 notitle,"data/statistics.txt" u 1:2 ls 1 ti "Norm",f(x) ls 6 notitle
set output "data/residual.png"
set ylabel "Residuals"
p "data/statistics.txt" u 1:($3-h($1)) ls 1 ti ""
